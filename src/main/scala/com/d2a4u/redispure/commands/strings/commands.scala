...
case class BitField[F[_]](key: String, subCommands: BitFieldSubCmd*)(implicit client: RedisClient[F], F: Effect[F])
    extends BasicRESPCmd[F, REArray] {
...
case class Decr[F[_]](key: String)(implicit client: RedisClient[F], F: Effect[F]) extends BasicRESPCmd[F, REInt] {
...
case class Get[F[_]](key: String)(implicit client: RedisClient[F], F: Effect[F]) extends BasicRESPCmd[F, REBulkString] {
...
case class GetRange[F[_]](key: String, start: Int, end: Int)(implicit client: RedisClient[F], F: Effect[F])
    extends BasicRESPCmd[F, REBulkString] {
...
case class GetSet[F[_], T](key: String, value: T)(implicit encoder: Encoder[T], client: RedisClient[F], F: Effect[F])
    extends BasicRESPCmd[F, RESimpleString.type] {
  override val cmd: REArray = REArray("GETSET", this.key, encoder.encode(this.value))
}

case class Incr[F[_]](key: String)(implicit client: RedisClient[F], F: Effect[F]) extends BasicRESPCmd[F, REInt] {
...
case class StrLen[F[_]](key: String)(implicit client: RedisClient[F], F: Effect[F]) extends BasicRESPCmd[F, REInt] {
